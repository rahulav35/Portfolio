...
const About = () => {
  ...
  console.log(index);
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left box-border ">
      <Circles />
      {/* avatar img */}
          ...
          <div className="  py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start box-border">
            {aboutData[index].info.map((item, itemIndex) => {
              return (
                <div
                  key={itemIndex}
                  className="flex-1 flex flex-col md:flex-row max-m-max gap-x-2 items-center text-white/60 "
                >
                  {/* title */}
